...
export default function InsufficientXPModal({ isOpen, onClose, requiredXP, currentXP }: InsufficientXPModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200 overflow-y-auto">
      ...
      <div className="relative bg-gradient-to-br from-zinc-900 via-zinc-900 to-black border-2 border-zinc-800 rounded-2xl w-full max-w-6xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 my-8">
        {/* Close Button */}
        <button
          onClick={onClose}
