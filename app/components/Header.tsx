...
import { Zap, User, Menu, Search, X, Home, Image as ImageIcon, DollarSign, Sparkles, LogOut, Settings, Palette, Shirt, Camera, Film, Scissors, Heart } from "lucide-react";
...
export default function Header() {
  ...
  const categoryItems = [
    { href: "/find-your-match", label: "Find Your Match ❤️", icon: Heart },
                ...
                <div className="relative">
                  ...
                  {showUserMenu && (
                    <div className="user-menu absolute right-0 mt-2 w-64 bg-zinc-900 border-2 border-zinc-800 rounded-xl shadow-xl overflow-hidden z-50">
                      ...
                      <div className="p-2">
                        <Link 
                          href={`/user/${(session.user as any)?.username || session.user?.email?.split('@')[0]}`}
