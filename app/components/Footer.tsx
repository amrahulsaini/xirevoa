    ...
    <footer className="border-t border-zinc-800/50 bg-black/50 backdrop-blur-xl py-8 sm:py-10">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-zinc-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-sm text-zinc-500">&copy; 2026 Xirevoa AI. All rights reserved.</p>
          <div className="flex gap-3">
            <a href="https://instagram.com/xirevoa" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-900 rounded-full flex items-center justify-center text-zinc-400 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
            ...
            <a href="https://www.linkedin.com/company/111801470/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-900 rounded-full flex items-center justify-center text-zinc-400 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.2 8.98h4.56V24H.2V8.98zM8.98 8.98h4.38v2.05h.06c.61-1.15 2.1-2.36 4.32-2.36 4.62 0 5.47 3.04 5.47 6.99V24h-4.56v-7.08c0-1.69-.03-3.86-2.35-3.86-2.36 0-2.72 1.84-2.72 3.74V24H8.98V8.98z"/></svg>
            </a>
            <a href="https://www.linkedin.com/in/rahul-saini-27ba9b383/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-900 rounded-full flex items-center justify-center text-zinc-400 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
