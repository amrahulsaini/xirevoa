      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-zinc-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-3">
            ...
            <a href="https://github.com/amrahulsaini" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-zinc-900 rounded-full flex items-center justify-center text-zinc-400 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
