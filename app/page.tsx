    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex gap-8 items-center">
                ...
                <button className="px-6 py-2.5 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold rounded-xl hover:shadow-lg hover:shadow-yellow-500/50 transition-all transform hover:scale-105">
                  Get Started
                </button>
              </nav>
            </div>
        ...
        <section className="container mx-auto px-6 pb-32">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-yellow-500/20 via-yellow-600/10 to-transparent border border-yellow-500/20 p-12 md:p-20 text-center">
            ...
            <div className="relative z-10">
              ...
              <button className="px-10 py-5 bg-gradient-to-r from-yellow-400 to-yellow-600 text-black font-bold text-xl rounded-xl hover:shadow-2xl hover:shadow-yellow-500/50 transition-all transform hover:scale-105">
                Start Your Journey
              </button>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="border-t border-zinc-800/50 bg-black/50 backdrop-blur-xl py-12">
          <div className="container mx-auto px-6">
            ...
            <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-zinc-500">&copy; 2026 Xirevoa AI. All rights reserved.</p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-zinc-900 rounded-full flex items-center justify-center text-zinc-400 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
