                    ...
                    <div className="flex items-center gap-4 relative z-10">
                      ...
                      <div className="flex gap-2">
                        {companionTemplates.map((template) => (
                          <div key={template.id} className="relative w-12 h-12 rounded-lg overflow-hidden border-2 border-pink-500/50 group-hover/card:border-pink-500 transition-all flex-shrink-0">
