      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="space-y-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group relative bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 hover:border-zinc-700 rounded-2xl p-8 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl"
            >
              ...
              <div className="relative flex items-start gap-6">
                ...
                <div className="flex-shrink-0">
                  <div className={`absolute blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 w-16 h-16 bg-gradient-to-br ${feature.gradient}`}></div>
