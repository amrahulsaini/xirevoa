...
async function getOutfitTemplates() {
  ...
  try {
    const [templates] = await connection.query<any[]>(
      'SELECT * FROM templates WHERE id IN (43, 44, 45, 46, 47, 48, 49, 50, 52, 53, 54, 55, 56, 57, 58, 59, 60, 71) ORDER BY FIELD(id, 43, 44, 45, 46, 47, 48, 49, 50, 52, 53, 54, 55, 56, 57, 58, 59, 60, 71)'
    );
...
export default async function ViewYourIconicOutfitPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 pt-28 sm:pt-36 md:pt-40">
        {/* Header Section */}
